...
import numpy as np
from rampwf.prediction_types.regression import make_predictions_type
from numpy.testing import assert_array_equal


def test_init():
    Predictions = make_predictions_type()
    y_pred = [0.7, 0.1, 0.2]
...
def test_init_empty():
    ...
    Predictions = make_predictions_type(label_names=[1, 2, 3])
