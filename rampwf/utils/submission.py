...
def train_test_submission(problem, submission_path, X_train, y_train, X_test,
        ...
        if is_partial_train:
            ...
            try:
                trained_model = problem.workflow.train_submission(
                    submission_path, X_train, y_train, train_is,
                    prev_trained_model)
...
def run_submission_on_cv_fold(problem, submission_path, fold, X_train,
    ...
    pred, timing = train_test_submission(
        problem, submission_path, X_train, y_train, X_test, is_pickle,
...
def run_submission_on_full_train(problem, submission_path, X_train, y_train,
